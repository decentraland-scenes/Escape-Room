...
export function CreateRoom5(gameCanvas: UICanvas) : void{
    ...
    const dialogTree = new SimpleDialog.DialogTree()
        .if(()=>firstTimeDialog)
            ...
            .say(()=>"A talking dog statue?!",{color: Color4.White()})
            .showPortrait(SimpleDialog.PortraitIndex.RIGHT, npcPortraitSurprised)
            .say(()=>"You're a talking bear yourself... you don't see me making any judgements.",{color: Color4.Yellow()})
            .showPortrait(SimpleDialog.PortraitIndex.LEFT, playerPortraitThinking)
            .showPortrait(SimpleDialog.PortraitIndex.RIGHT, npcPortraitDefault)
            .say(()=>"Anyway... how do I get out of this place?",{color: Color4.Yellow()})
            .showPortrait(SimpleDialog.PortraitIndex.RIGHT, npcPortraitThinking)
            .say(()=>"You'll have to pass through me. And I'll only let you if you answer my three questions.",{color: Color4.Yellow()})
            .showPortrait(SimpleDialog.PortraitIndex.RIGHT, npcPortraitSurprised)
            .showPortrait(SimpleDialog.PortraitIndex.LEFT, playerPortraitSurprised)
            .say(()=>"So go ahead, explore the other rooms and solve the puzzles to find the answers to my questions!",{color: Color4.Yellow()})
            .say(()=>"Um... sure, why not? Who am I to argue?",{color: Color4.White()})
            .wait(3)
        .else()
            ...
            .if(()=>firstOptionCorrect && secondOptionCorrect && thirdOptionCorrect)
                .say(()=>"We're done talking. \nEnter the code and you can leave.",{color: Color4.Yellow()})
                .wait(3)
            .else()
                .say(()=>"Did you solve my puzzles? Do you know the answers?",{color: Color4.Yellow()})
                .showPortrait(SimpleDialog.PortraitIndex.LEFT, playerPortraitThinking)
                .beginOptionsGroup()
                    .option(()=>"Yes. Why do you think I came all the way down here?")
                        .showPortrait(SimpleDialog.PortraitIndex.LEFT, playerPortraitDefault)
                        .say(()=>"Yes. Why do you think I came all the way down here?",{color: Color4.White()})
                        .showPortrait(SimpleDialog.PortraitIndex.RIGHT, npcPortraitSurprised)
                        .say(()=>randomStartingOptions[Math.floor(Math.random()*(randomStartingOptions.length-1))],{color: Color4.Yellow()})
                        .showPortrait(SimpleDialog.PortraitIndex.RIGHT, npcPortraitThinking)
                        .say(()=>"Very well then... answer me this:",{color: Color4.Yellow()})
                        .showPortrait(SimpleDialog.PortraitIndex.RIGHT, npcPortraitDefault)
                        .if(()=>!firstOptionCorrect)
                            ...
                            .beginOptionsGroup()
                                ...
                                .endOption()
                                .option(()=>"Blue.")
                                    .say(()=>"Blue... right?",{color: Color4.White()})
                                    .showPortrait(SimpleDialog.PortraitIndex.RIGHT, npcPortraitSurprised)
                                    .say(()=>randomWrongAnswers[Math.floor(Math.random()*(randomWrongAnswers.length-1))],{color: Color4.Yellow()})
                                .endOption()
                                .option(()=>"Orange.")
                        ...
                        .else()
                            .if(()=>!secondOptionCorrect)
                                ...
                                .beginOptionsGroup()
                                    ...
                                    .endOption()
                                    .option(()=>"Bowling.")
                                        .say(()=>"Of course… It’s bowling... right?",{color: Color4.White()})
                                        .showPortrait(SimpleDialog.PortraitIndex.RIGHT, npcPortraitSurprised)
                                        .say(()=>randomWrongAnswers[Math.floor(Math.random()*(randomWrongAnswers.length-1))],{color: Color4.Yellow()})
                                    .endOption()
                                .endOptionsGroup()
